...
public:
    ...
    /* Do NOT override the 2-arg readDirectory: the default forwards
       `*this` as the sub-accessor, so dumpPath()'s recursion stays
       inside this wrapper and every walked file is recorded. */
